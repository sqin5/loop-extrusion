...
namespace LAMMPS_NS
{
   ...
   private:
      ...
      double *distsq_c, *distsq_b;
      double *probability;
      int *move_left_status, *move_right_status ;
      double *left_flag, *right_flag; 
      int *ccount, *clist; 
      int *changed_flag;  
      int *isend;   
      ...
      int neutral_type, ctcf_left, ctcf_right, ctcf_left_right, linker; //already have btype
      double through_prob, linker_prob;
      int ttype;
      double safe_distance, safe_dsq;
      double alpha;    
