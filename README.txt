...
##For output, positions of each polymer bead is saved in TAD_${seed}.lammpstrj, and bond information is stored in bond_info${seed}.txt 
 
##If you meet any problems with the LAMMPS code or running sample scripts, please contact me. 